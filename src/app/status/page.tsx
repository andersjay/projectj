    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="w-[400px] bg-zinc-300 p-4 rounded">
        <div className="w-full flex items-center justify-center gap-2">
          <div className={classNames(`rounded-full w-[40px] h-[40px] flex items-center justify-center ${status.status === 'waiting'  || 'inProgress' ? 'bg-green-500' : 'border-2 border-slate-700 bg-slate-500'}`)}>
          ...
          <div className={classNames(`rounded-full w-[40px] h-[40px] flex items-center justify-center ${status.status === 'inProgress' || 'finished' ? 'bg-green-500' : 'border-2 border-slate-700 bg-slate-500'}`)}>
