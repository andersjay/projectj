...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {menuIsOpen ? (
        <div className="fixed top-0 left-0 md:static">
          <div className="w-[250px] h-full bg-slate-950 fixed top-0 left-0">
            <div className="flex items-center justify-between p-4">
              <h1 className="font-bold text-2xl">LOGO</h1>
              <button onClick={handleOpenSidebar} className="text-2xl lg:hidden"><X size={32} /></button>
            </div>
            <div className="flex flex-col items-center justify-center gap-4">
              <a href="/dashboard/home" className="text-2xl font-bold">Inicio</a>
